const CACHE='hooptrack-v2.2.0';
const ASSETS=['./','./index.html','./styles.css','./app.js?v=2.2.0','./graphic-renderer.js?v=2.2.0','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./images/bg.png'];
