const CACHE='hooptrack-v2.3.1';
const ASSETS=['./','./index.html','./styles.css','./app.js?v=2.3.1','./graphic-renderer.js?v=2.3.1','./cloud-sync.js?v=2.3.1','./firebase-config.js','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./images/bg.png'];
